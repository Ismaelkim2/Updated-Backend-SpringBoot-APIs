...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("https://brishkimecoeggs.onrender.com", "http://localhost:4200"));
        configuration.setAllowedOriginPatterns(Arrays.asList("https://*.onrender.com", "http://localhost:4200"));
